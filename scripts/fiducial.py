if __name__ == "__main__":
    ...
    out_name = "20230725_vit_DES_half_sky"
    out_dir = f"../models/fiducial/{out_name}/"
    scaler_dir = f"../models/{out_name}/scalers/"
    Path(out_dir).mkdir(parents=True, exist_ok=True)

    # data = load_dataset("../data/fiducial_224x224/fiducial_224x224.py", "old_DES",
    #                 cache_dir="/data2/shared/shubh/cache")
    data = load_dataset("../data/fiducial_224x224/fiducial_224x224.py", "old_DEShalf",
                    cache_dir="/data2/shared/shubh/cache")
    subset = "test"
    ...
    try:
        ...
        scalers = [joblib.load(scaler_dir + label + ".pkl") for label in labels]
